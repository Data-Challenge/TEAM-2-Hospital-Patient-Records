...
# Price correlation of length of stay and total charges
cleaned_df.plot(x='length_of_stay', y='total_charges', kind='scatter', title="Price correlation of length of stay and total charges", ylabel="Total Charges", xlabel="Length of Stay")
